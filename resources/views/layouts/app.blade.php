...
<head>
    ...
    <title>{{ config('app.name', 'Scottish') }}</title>
...
<body class="g-sidenav-show  bg-gray-200">
    ...
    <aside
        ...
        <div class="sidenav-header">
            ...
            <a class="navbar-brand m-0 admin-logo" href="/admin">
                <img src="{{ Vite::asset('resources/images/logo.png') }}" class="navbar-brand-img h-100"
                    alt="main_logo">
            </a>
        </div>
        ...
        <div class="collapse navbar-collapse  w-auto  max-height-vh-100" id="sidenav-collapse-main">
            <ul class="navbar-nav">
                <li class="nav-item">
                    <a class="nav-link text-dark {{ request()->routeIs('admin.home') ? 'active bg-gradient-primary' : '' }}"
                ...
                <li class="nav-item">
                    <a class="nav-link text-dark {{ request()->routeIs('players.index') ? 'active bg-gradient-primary' : '' }}"
                        href="{{ route('players.index') }}">
                        <div class="text-dark text-center me-2 d-flex align-items-center justify-content-center">
                            <i class="material-icons opacity-10">sports_cricket</i>
                        </div>
